...
public class Constants {
    ...
    public static final String SQS_QUEUE_PATH = ApplicationProperties.getProperty("SQS_QUEUE_PATH");
    public static final String SQS_QUEUE_NAME = "cst-test-queue";
    public static final String SQS_QUEUE_URL = SQS_ENDPOINT + SQS_QUEUE_PATH + SQS_QUEUE_NAME;
